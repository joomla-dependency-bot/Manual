...
The code is available at [com_example step 11](https://github.com/joomla/manual-examples/tree/main/component-tutorial/step11_publishing).
...
- `cid[]` - set to an array of the database ids of the records to be published
...
- `cid[]` - set to an array of the database ids of the records to be unpublished
...
so that on large devices col-lg-3 occupies 25% and col-lg-9 occupies 75% of the whole.
